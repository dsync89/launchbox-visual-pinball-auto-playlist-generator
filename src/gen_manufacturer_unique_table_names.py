...
if __name__ == "__main__":
    ...
    filtered_df = df[df['Manufacturer'].str.contains('|'.join(keywords_to_select))]
    ...
    for keyword in keywords_to_select:
        ...
        keyword_filtered_df = unique_filtered_df[unique_filtered_df['Manufacturer'].str.contains(keyword)]
        ...
        keyword_csv_file_path = f'vpx-manufacturer-{keyword}.csv'
